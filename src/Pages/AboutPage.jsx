    ...
    >
      ...
      >
        ...
        <p className="text-gray-700">
          Women's safety is not just a personal concern but a societal issue. A safe environment allows women to
          grow, learn, and contribute to society without fear. Raising awareness, supporting victims, and enforcing
          strict laws are necessary steps toward a safer future.
        </p>
      </motion.section>
      ...
      <motion.section
        ...
        whileHover={{ scale: 1.02 }}
      >
        <h2 className="text-2xl font-semibold text-blue-700 mb-2">Essential Safety Tips 🛡️</h2>
        <ul className="list-disc pl-5 text-gray-700 space-y-2">
          <li>📍 Always share your live location with a trusted person.</li>
          <li>🚶 Be aware of your surroundings and avoid dark, isolated areas.</li>
          <li>👜 Carry a self-defense tool like pepper spray or a safety alarm.</li>
          <li>🔊 Trust your instincts—if something feels off, seek help immediately.</li>
          <li>🚌 Prefer well-lit, crowded streets when traveling alone at night.</li>
        </ul>
      </motion.section>
      ...
      <motion.section
        ...
        whileHover={{ scale: 1.02 }}
      >
        <h2 className="text-2xl font-semibold text-green-700 mb-2">Technology for Women's Safety 📱</h2>
        <p className="text-gray-700">Several apps provide quick emergency assistance:</p>
        <ul className="list-disc pl-5 text-gray-700 space-y-2">
          <li>📞 <strong>112 India:</strong> National emergency helpline app</li>
          <li>📲 <strong>Shake2Safety:</strong> Shake phone to send emergency alert</li>
          <li>📍 <strong>My Safetipin:</strong> Helps identify safe & unsafe areas</li>
          <li>🆘 <strong>bSafe:</strong> GPS tracking & emergency alarms</li>
        </ul>
      </motion.section>
      ...
      <motion.section
        ...
        whileHover={{ scale: 1.02 }}
      >
        <h2 className="text-2xl font-semibold text-yellow-700 mb-2">Legal Rights & Helpline Numbers 📜</h2>
        <ul className="list-disc pl-5 text-gray-700 space-y-2">
          <li>📞 <strong>National Women Helpline:</strong> 181</li>
          <li>🚔 <strong>Police Emergency:</strong> 112</li>
          <li>🏠 <strong>Domestic Abuse Helpline:</strong> 1091</li>
      ...
      >
        <p className="text-lg font-semibold text-gray-800">
          "Empowerment begins with awareness. Together, we can build a safer world for women." 💜
        </p>
      </motion.section>
    </motion.div>
  );
